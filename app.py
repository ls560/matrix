...
# Стилізація інтерфейсу через CSS: робимо компактний адаптивний дизайн
st.markdown("""
    <style>
...
# 3 випадаючі списки в один рядок
...
if st.button("Розрахувати", use_container_width=True):
    ...
    # Окремий підрахунок символів для клітинок
    ...
    # Розрахунок лінійних параметрів
    chyslo_doli = num2
    ...
    # 4. ВІДОБРАЖЕННЯ КАРТКИ (HTML/CSS)
    if user_name:
